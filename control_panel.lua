--名字使用cp.lua会出现奇怪的bug：http://hiwifi.com/cgi-bin/turbo/;stok=xxxxxxxxxxxxxxxxxx/admin_web/ 显示的是互联网的内容
module("luci.controller.admin_web.control_panel", package.seeall)
