--[[
名字使用cp.lua会出现奇怪的bug：http://hiwifi.com/cgi-bin/turbo/;stok=xxxxxxxxxxxxxxxxxx/admin_web/ 显示的是http://hiwifi.com/cgi-bin/turbo/;stok=xxxxxxxxxxxxxxxxxx/admin_web/network 的内容
使用control_panel.lua也是出现这个问题。百思不得其解，这锅极路由背。
只能起个别的名字了……绝望……why_i_cant_use_name_cp。
]]--
